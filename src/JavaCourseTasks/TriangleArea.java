...
public class TriangleArea {
    public static void main(String[] args) {
        ...
        double deltaX1MultipleDeltaY2 = (points[0][1] - points[1][1]) * (points[0][0] - points[2][0]);
        ...
        if (Math.abs(deltaX1MultipleDeltaY2 - deltaX2MultipleDeltaY1) <= epsilon) {
            ...
            double triangleSide1 = Math.sqrt(Math.pow((points[0][0] - points[1][0]), 2) + Math.pow((points[0][1] - points[1][1]), 2));
            double triangleSide2 = Math.sqrt(Math.pow((points[0][0] - points[2][0]), 2) + Math.pow((points[0][1] - points[2][1]), 2));
            double triangleSide3 = Math.sqrt(Math.pow((points[1][0] - points[2][0]), 2) + Math.pow((points[1][1] - points[2][1]), 2));

            double triangleSemiPerimeter = (triangleSide1 + triangleSide2 + triangleSide3) / 2;

            double triangleArea = Math.sqrt(triangleSemiPerimeter * (triangleSemiPerimeter - triangleSide1) *
                    (triangleSemiPerimeter - triangleSide2) * (triangleSemiPerimeter - triangleSide3));
